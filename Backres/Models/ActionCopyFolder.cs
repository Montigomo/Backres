...
{
	internal class ActionCopyFolder : ActionAbstract, IAction
	{

		public ActionCopyFolder(BackresAction bAction, ActionDirection bDirection) : base(bAction, bDirection)
		{
		}
